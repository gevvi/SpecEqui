"""
Django settings for SpecEqui project.
...
SECRET_KEY = 'django-insecure-=+ng^!p1%ml#ox7b4^&&y^4lwqp1-i)b)y2fc6#1kx%=3#3q49'
...
WSGI_APPLICATION = 'SpecEqui.wsgi.application'
